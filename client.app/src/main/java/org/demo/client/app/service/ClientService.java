...
public class ClientService {
    ...
    public void createDemoData() {
        ...
        List<String> names = Arrays.asList("Mario Rossi", "Luigi Bianchi", "Paolo Marchetti", "Fabio Ricci", "Bruno Bruno");
        ThreadLocalRandom generator = ThreadLocalRandom.current();
        for (String name : names) {
            Client client = new Client();
            client.setName(name);
            client.setEmail(name.replaceAll("\\s+",".").toLowerCase()+"@gmail.com");
