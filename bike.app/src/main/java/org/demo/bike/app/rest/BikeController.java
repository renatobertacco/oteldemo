...
public class BikeController {
    ...
    public List<BikeDTO> findAll(@RequestParam Map<String, String> params) {
        if (params.isEmpty()) {
            ...
            return service.findAll(toLong(params.get("id")), params.get("model"), toSizeDTO(params.get("size")),
                    toLong(params.get("clientId")));
        }
    }
    ...
    public BikeDTO setRentedBy(@PathVariable(name = "bikeId") Long bikeId,
